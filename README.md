...
- Implementation of various counting systems
- Statistical analysis of counting effectiveness
...
- Hits on 16 or less
- Stands on 17 or more (configurable for soft 17)
- Automatic blackjack checking
- Standard payout procedures
